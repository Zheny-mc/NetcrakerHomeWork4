...
public class TestArrayList {
    ...
    public void sourceTestAdd(ArrayListForTest listForTest) {
    ...
    @OutputTimeUnit(TimeUnit.NANOSECONDS)
    @BenchmarkMode(Mode.AverageTime)
    public void sourceTestUpdate(ArrayListForTest listForTest) {
    ...
    @OutputTimeUnit(TimeUnit.NANOSECONDS)
    @BenchmarkMode(Mode.AverageTime)
    public void sourceTestDelete(ArrayListForTest listForTest) {
        listForTest.integers = readTestData();
